...
//   return (
//     <div>
//       <form  className="mx-auto w-50" onSubmit={handleRegistration}>
...
//       </form>
//       <br /><br /><br />
//          <div className="text-center" >  <button type="button"  className="btn-danger mx-auto rounded btn-secondary btn-sm" onClick={handleGoogleSignIn} >Google Sign In</button></div>
//     </div>
//   );
// }
